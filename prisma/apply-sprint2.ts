/**
 * Applies the Sprint 2 migration (prisma/migrations-sprint2.sql).
 *
 * Mirrors apply-sprint1.ts — fresh PrismaClient per attempt, retries
 * transient Supabase pooler drops. SQL is fully idempotent.
 *
 * Run: npx tsx prisma/apply-sprint2.ts
 */
...
async function main() {
  const sql = readFileSync(join(__dirname, "migrations-sprint2.sql"), "utf8");
  ...
  console.log("✅ Sprint 2 migration applied.");
}
