/**
 * Applies the Teacher Pay migration
 * (prisma/migrations-teacher-pay.sql) to the Supabase database.
 *
 ...
 *
 * Run: npx tsx prisma/apply-teacher-pay.ts
 */
...
async function main() {
  const sql = readFileSync(join(__dirname, "migrations-teacher-pay.sql"), "utf8");
  ...
  console.log("✅ Teacher Pay migration applied.");
}
